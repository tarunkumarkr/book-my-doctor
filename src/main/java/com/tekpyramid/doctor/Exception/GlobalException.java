...
import com.tekpyramid.doctor.Response.FailureResponse;
...
public class GlobalException {
    ...
    @ExceptionHandler(DuplicationExceptionHandler.class)
    public ResponseEntity<FailureResponse> duplicateRecordHandler(DuplicationExceptionHandler exception){
